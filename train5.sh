# 調整sigma_offsets, 讓LL偏fidelity, 高頻偏realism, 並且讓四個子帶均等起步
    ...
    # ).to(DEVICE)
# name="dcae_wd32_512_static_from0240_mse_20_tuning_msd_gate_v5_only_nt_margin01"
...
#     --patch-size 512 512 --msd-weight 5 \
...
name="dcae_wd32_512_static_from0240_mse_20_tuning_msd_gate_v5_all_margin01"
python train_all.py -d /home/at9529/ycw.cs14/Michael/MLIC/mlic_train_100k --cuda --checkpoint /home/at9529/ycw.cs14/Michael/massive_activation/DCAE/ckpt_epoch/dcae_wd32_512_static_from0240_mse_20_tuning_msd_gate_v5_only_nt_margin01/iter_7200.pth.tar \
    --lambda 1 --wd-weight 0.25 --mse-weight 0 --final-mse-weight 5 \
